...
public class GamePanel extends JPanel implements Runnable {
    ...
    public void checkColision() {
        ...
        if (paddle1.y <= 0 || paddle1.y >= GAME_HEIGHT - PADDLE_HEIGHT) {
            paddle1.setYDirection(-paddle1.yVelocity);
        }

        if (paddle2.y <= 0 || paddle2.y >= GAME_HEIGHT - PADDLE_HEIGHT) {
            paddle2.setYDirection(-paddle2.yVelocity);
        }
